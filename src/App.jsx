...
function PrivateRoute({ children, managerOnly = false }) {
  ...
  if (loading) return <div style={{display:"flex",alignItems:"center",justifyContent:"center",height:"100vh",color:"#888"}}>YUKLENIYOR...</div>;
...
function AppRoutes() {
  ...
  return (
    <Routes>
      <Route path="/login" element={session && staffUser ? <Navigate to={d} replace /> : <LoginPage />}/>
