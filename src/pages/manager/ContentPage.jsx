...
export default function ContentPage() {
  ...
  // Yuklemeden once tarayicida kucultulur (lib/gorsel.js): blog gorseli 230 px
  // yukseklikte gosteriliyor, en uzun kenar 1000 px fazlasiyla yeter.
  const uploadPhotos = async (e) => {
    ...
    for (const ham of files) {
      const f = await kucult(ham, { enUzun: 1000, kalite: 0.82 });
